        ...
        <>
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        ...
                        <div className="carousel-caption d-none my-auto d-md-block">
                            <h1 className="text-warning text-xl">Welcome To CloudNotes</h1>
                    ...
                    <div className="carousel-item">
                        ...
                        <div className="carousel-caption d-none d-md-block">
                            ...
                            <p>CloudNotes is a free platform to manage your notes.</p>
                        </div>
                    </div>
                </div>
                <button
            ...
            <div className="container px-4 py-5" id="featured-3">
                ...
                <div className="feature col mb-4">
                        ...
                        <Link to="/signup" className="btn btn-success icon-link">
                            Get Started
                        </Link>
                    </div>
                    <div className="feature col mb-4">
